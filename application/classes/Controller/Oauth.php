...
abstract class Controller_OAuth extends Controller_Account {
	...
	public function before()
	{
		...
		$this->_config = Kohana::$config->load('oauth.'.strtolower($this->name));
	...
	protected function _do_login()
	{
		...
		HTTP::redirect($this->_provider->authorize_url($token));
	}
	...
	public function action_identify()
	{
		...
		{
			$this->_error('Authentication failed due wrong token');
